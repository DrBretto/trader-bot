# Evidence comparison — SYN-1 @ cost seed 4243 (R13) vs SYN-1 @ cost seed 4242 (R01)

Holdout boundary: 2026-03-11. Delta = SYN-1 @ cost seed 4243 (R13) − SYN-1 @ cost seed 4242 (R01).
...
| metric | SYN-1 @ cost seed 4243 (R13) | SYN-1 @ cost seed 4242 (R01) | delta |
|---|---|---|---|
...
NOTE: SEED SENSITIVITY: raw_value column ASSERTED byte-identical to R01 (strategy path is seed-free); only the post-hoc cost overlay differs. Cost-adjusted endpoints: R13=104331.95 vs R01=104329.46.
