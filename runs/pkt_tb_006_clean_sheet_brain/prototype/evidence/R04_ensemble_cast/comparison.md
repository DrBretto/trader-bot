# Evidence comparison — SYN-1 (R01) vs CAST OFF, trust renorm (R04)

Holdout boundary: 2026-03-11. Delta = SYN-1 (R01) − CAST OFF, trust renorm (R04).
...
| metric | SYN-1 (R01) | CAST OFF, trust renorm (R04) | delta |
|---|---|---|---|
| total_return | +1.23% | +0.03% | +1.20% |
| cagr | +4.93% | +0.11% | +4.82% |
| sharpe | +1.6541 | +0.0679 | +1.5862 |
| max_drawdown | +1.32% | +0.79% | +0.53% |
| win_rate | +51.56% | +53.12% | -1.56% |
| realized_round_trips | 4 | 11 | -7 |
| cumulative_transaction_costs | +0.0000 | +17.7248 | -17.7248 |
| avg_gross_exposure | +25.72% | +9.44% | +16.28% |

Paired daily diff: n=64, mean=+1.88 bp/day, sd=+14.20 bp/day, t=+1.06, HAC t=+1.19, 95% CI [-0.0001, +0.0005], MDE(|t|=2)=+0.0003

## Holdout only

| metric | SYN-1 (R01) | CAST OFF, trust renorm (R04) | delta |
|---|---|---|---|
| total_return | +1.30% | +0.15% | +1.14% |
| cagr | +7.67% | +0.89% | +6.79% |
| sharpe | +2.4980 | +0.4593 | +2.0388 |
| max_drawdown | +0.59% | +0.51% | +0.08% |
| win_rate | +54.55% | +47.73% | +6.82% |
| realized_round_trips | 0 | 6 | -6 |
| cumulative_transaction_costs | +0.0000 | +6.4615 | -6.4615 |
| avg_gross_exposure | +25.71% | +10.40% | +15.32% |

Paired daily diff: n=44, mean=+2.59 bp/day, sd=+14.06 bp/day, t=+1.22, HAC t=+1.43, 95% CI [-0.0001, +0.0006], MDE(|t|=2)=+0.0004
...
- CAST OFF, trust renorm (R04): `{"arm": "syn1", "code_sha": {"git": "747c58f8f640", "prototype_wiring": "3edd62e80aa1"}, "command": "python /Users/drbretto/Desktop/Projects/trader-bot/runs/pkt_tb_006_clean_sheet_brain/prototype/run_replay.py --arm syn1 --window full --out /Users/drbretto/Desktop/Projects/trader-bot/runs/pkt_tb_006_clean_sheet_brain/prototype/runs_battery/R04 --cost-seed 4242 --genome /Users/drbretto/Desktop/Projects/trader-bot/runs/pkt_tb_006_clean_sheet_brain/prototype/runs_battery/R04/genome.json --exec-dir /Users/drbretto/Desktop/Projects/trader-bot/runs/pkt_tb_006_clean_sheet_brain/prototype/exec_out --exec-mode linear_twin", "cost_model": {"seed": 4242, "version_sha": "bf8b77716f74"}, "evidence_protocol": "committee/EVIDENCE_PROTOCOL.md V1", "exec_mode": "linear_twin", "exec_weights_dir": "/Users/drbretto/Desktop/Projects/trader-bot/runs/pkt_tb_006_clean_sheet_brain/prototype/exec_out", "generated": "2026-06-10T18:44:16", "genome": {"abstain_threshold": 0.2443899204544654, "cash_floor": 0.1031998699462734, "conviction_temp": 4.0, "dd_brake_strength": 1.0, "dd_brake_threshold": 0.08001844143783443, "event_weight_cap": 0.8795265838631618, "feature_gate": [0, 1, 0, 1, 1, 1, 1, 1], "gross_target": 0.5157883065754484, "max_symbol_weight": 0.08175373267203596, "member_gate": [0, 1, 1], "no_trade_band": 0.02596656629933275, "record_weight_eps": 0.38223385230068074, "risk_aversion_lambda": 3.477283678899133, "trust_halflife_days": 41.740361368232826, "trust_prior": [-0.7976769586105441, 1.8441695577251007, -1.429998600799269], "vol_target_ann": 0.08648335911431486}, "genome_hash": "f5874d73a1ee", "n_trading_dates": 84, "native_start_portfolio_date": "2026-03-11", "nightly_audit": {"dir": "nightly_audit", "n_files": 130}, "nightly_manifest": {"cast_n_seeds": 3, "code_sha": "e620dc0e34a6", "generated": "2026-06-10T17:35:57", "window": ["2026-02-02", "2026-06-09"]}, "sigma_source": {"book_vol_key": "book_vol_hat_proxy", "mode": "trailing21", "sigma_col": "sigma_hat_proxy"}, "snapshot_range": ["2026-02-03", "2026-06-10"], "start_portfolio_date_used": "2026-02-03", "summary": {"actions_per_decision_date": 0.277, "arm": "syn1", "cost_bps_of_traded": 3.24, "cost_drag_bps_of_start_nav": 4.542, "final_value_cost_adjusted": 103083.52507432738, "final_value_raw": 103130.35, "first_date": "2026-02-04", "last_date": "2026-06-10", "n_decision_dates": 65, "n_executed_actions": 18, "start_value": 103084.96, "total_cost_dollars": 46.8249, "total_traded_dollars": 144520.51, "window": "full"}, "variant_params_hash": "3023921c7bc7", "wall_clock_s": 3.4, "window": "full"}`
...
NOTE: ORIENTATION: E2 = R01 − R04 (with-member minus member-dropped). E1 read: evidence/e1_reads.json['ensemble_cast_drop'] (with=syn1_frozen_base, without=cast_off_renorm).

## E1 primary read

HAC t=+0.17 on n=1507 pooled fold-days, mean=+0.0000, CI95=[-0.0001, +0.0001], MDE=+0.0001
