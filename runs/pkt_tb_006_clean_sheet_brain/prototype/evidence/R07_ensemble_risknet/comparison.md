# Evidence comparison — RiskNet-sigma candidate arm (R07) vs SYN-1 deployed trailing-21 (R01)

Holdout boundary: 2026-03-11. Delta = RiskNet-sigma candidate arm (R07) − SYN-1 deployed trailing-21 (R01).
...
| metric | RiskNet-sigma candidate arm (R07) | SYN-1 deployed trailing-21 (R01) | delta |
|---|---|---|---|
...
Paired daily diff: n=64, mean=+0.00 bp/day, sd=+0.00 bp/day, t=n/a, HAC t=n/a, 95% CI [+0.0000, +0.0000], MDE(|t|=2)=+0.0000
...
NOTE: ORIENTATION: E2 = R07 − R01 (candidate minus deployed, matching the e1_reads DIRECTION note). FINDING: R07 series byte-identical to R01 (--sigma-source trailing21 IS the deployed FREEZE convention) -> contrast DEGENERATE (diff ≡ 0, paired t undefined). R07 stays in the record as a consumed look that measured the null contrast by construction; the live risknet E2 read is evidence/R19_ensemble_risknet/ (contingency replay).
