...
from chassis.signals.macro_credit import compute_macro_credit
from chassis.signals.vol_uncertainty import compute_vol_uncertainty
from chassis.signals.fragility import compute_fragility
from chassis.signals.entropy_shift import compute_entropy_shift
...
def run(
    ...
    # --- 1. Macro/Credit ---
    try:
        from chassis.steps.ingest_fred import get_latest_values
