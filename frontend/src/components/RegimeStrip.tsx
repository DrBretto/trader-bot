  ...
  return (
    <div style={{ flex: 1, minWidth: 120 }}>
      <div
        ...
        title={`${label} normalized over [${min.toFixed(2)}, ${max.toFixed(2)}].`}
      >
        {label}
      </div>
  ...
  return (
    <div className="card" style={{ marginBottom: 0 }}>
      <div className="card-title">
        ...
        <InfoTooltip
          content={`Top-level fused signal summary.
Shows the chosen regime, confidence, throttle, expert gauge levels, and a compact history strip of recent regime states.`}
      ...
      <div
        ...
        title="Final regime selected after applying fusion rules and overrides."
      >
        <div style={{
      ...
      {timeseries.length > 0 && (
        <div style={{ marginTop: 16 }}>
          <div
            ...
            title="Most recent 60 observations of the final fused regime label."
          >
            Regime History
          </div>
